...
import com.wubaba.mall.sms.entity.SmsMemberPriceEntity;
import com.wubaba.mall.sms.service.SmsMemberPriceService;
...
public class SmsMemberPriceController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("sms:smsmemberprice:list")
    public R list(Page page, SmsMemberPriceEntity entity){
        Page<SmsMemberPriceEntity> pageData = smsMemberPriceService.page(page, Wrappers.query(entity));
   ...
   // @RequiresPermissions("sms:smsmemberprice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("sms:smsmemberprice:save")
    ...
    //@RequiresPermissions("sms:smsmemberprice:update")
    ...
    //@RequiresPermissions("sms:smsmemberprice:delete")
