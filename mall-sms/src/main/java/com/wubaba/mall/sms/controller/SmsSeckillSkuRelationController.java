...
import com.wubaba.mall.sms.entity.SmsSeckillSkuRelationEntity;
import com.wubaba.mall.sms.service.SmsSeckillSkuRelationService;
...
public class SmsSeckillSkuRelationController {
    ...
    public R list(Page page, SmsSeckillSkuRelationEntity entity){
        Page<SmsSeckillSkuRelationEntity> pageData = smsSeckillSkuRelationService.page(page, Wrappers.query(entity));
