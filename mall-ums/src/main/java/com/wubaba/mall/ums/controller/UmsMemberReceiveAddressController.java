...
import com.wubaba.mall.ums.entity.UmsMemberReceiveAddressEntity;
import com.wubaba.mall.ums.service.UmsMemberReceiveAddressService;
...
public class UmsMemberReceiveAddressController {
    ...
    public R list(Page page, UmsMemberReceiveAddressEntity entity){
        Page<UmsMemberReceiveAddressEntity> pageData = umsMemberReceiveAddressService.page(page, Wrappers.query(entity));
